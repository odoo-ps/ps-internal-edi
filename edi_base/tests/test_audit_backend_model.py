...
class TestEdiSynchronizationBackendModel(TestEDICommon):
    ...
    def test_backend_records_sync_lifecycle(self):
        ...
        backend._audit_received(entry, "hello")
    ...
    def test_auditrun_drives_edi_synchronization_end_to_end(self):
        ...
        entry (the sync record) through received/sent, and commits independently."""
        ...
        with audit_run(
            ...
            run.received("in-data")
            run.sent("out-data")  # exercises _audit_sent
